...
The `--coverprofile` flag accepts a path to a Go coverage profile generated by `go test -coverprofile`. When provided, Gaze skips its internal test run and uses the existing profile directly.
